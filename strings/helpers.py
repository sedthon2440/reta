...
◈ تشغيل + اسم الاغنية
-› لتشغيل بالمجموعة أو القناة

◈ انهاء او ايقاف
-› لإيقاف تشغيل الأغنية 

◈ تخطي
-› لتشغيل الأغنية التالي وتخطي الحالي

◈ فيديو
-› لتشغيل فيديو في المحادثة الصوتية

◈ مؤقت
 -› لإيقاف التشغيل بشكل مؤقت

◈ استئناف
-› لإكمال التشغيل بعد الإيقاف المؤقت

◈ الصاعدين
-› لمعرفه الاشخاص الموجودين بالاتصال

[𝗗𝗲𝘃 𝗦𝗼𝘂𝗿𝗖𝗲](https://t.me/NUNUU)
"""
...
⋙ بحث أو يوت
-› لتنزيل الأغنية من اليوتيوب

⋙ كتم و الغاء كتم
-› لكتم شخص مزعج بالمجموعة 

◈ لعبة البنك
-› إنشاء حساب بنكي ثم.. تابع الخطوات

◈ نادي المطور
-› للحصول على مساعدة أو دعم من صاحب البوت

◈ لو خيروك او خيروك
-› لعبة من ضمن العاب البوت

◈ لعبة حروف أو احرف
-› لعبة من ضمن ألعاب البوت

◈ انشاء رابط
-› لصنع رابط مؤقت لجروبك

◈ تفعيل الاذان
-› لتفعيل الآذان بالكروب أو بالقنوات

◈ قرآن
-› للاستماع إلى آيات قرآنية
...
HELP_8 = """
<b><u>↢ أوامر إضافية</b></u>

⋙ الساعة
-  لمعرفة الساعة بتوقيت الأردن

⋙ معلومات المجموعة 
-› لمعرفه معلومات المجموعة كاملة

⋙ تلجراف ميديا
-› قم بإرسال صورة للبوت و اعمل رد واكتب تلكراف ميديا
"""
