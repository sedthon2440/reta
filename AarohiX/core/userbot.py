...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("veevvw")
                await self.one.join_chat("sedthon_help")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("veevvw")
                await self.two.join_chat("sedthon_Help")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("veevvw")
                await self.three.join_chat("sedthon_Help")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("veevvw")
                await self.four.join_chat("sedthon_Help")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("veevvw")
                await self.five.join_chat("sedthon_Help")
            except:
                pass
            assistants.append(5)
